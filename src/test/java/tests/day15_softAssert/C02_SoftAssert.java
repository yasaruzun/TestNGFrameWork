...
public class C02_SoftAssert {
    ...
    public void test01(){
        ...
        softAssert.assertEquals(actualDropDownSecim,expectedDropDownSecim,"euzone secimi testi failed");

        // 10. soft assert kullanarak DropDown listesinin su secenekleri oldugunu test edin “Select One”,


        // “Australia (dollar)“, “Canada (dollar)“,”Switzerland (franc)“,”China (yuan)“,”Denmark (krone)“,”Eurozone (euro)“,
        ...
        for (WebElement eachOptionElement: optionElementListesi
             ) {
            actualOptionsListesiStr.add(eachOptionElement.getText());
        }
