...
public class C04_HardAssert {
    ...
    /*
        ...
        biz raporlar dedigimizde calisan assertion'lardan kacinin failed oldugunu soyler
        ve failed olan assertion varsa raporlar dedigimiz satirda calismayi durdurur
     */
